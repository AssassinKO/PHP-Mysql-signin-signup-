            ...
            <main>
                <div class="container-fluid">
                    <div class="title">Settings</div>
                        <div class="row content" style="padding:  20% 40%;">
                            <div class="form-check col-md-12" >
                                <input class="form-check-input" type="radio" onchange="background('dark')" name="exampleRadios" id="exampleRadios1" value="option1" checked>
                            ...
                            <br><br>
                            <div class="form-check col-md-12">
                                <input class="form-check-input" type="radio" onchange="background('white')" name="exampleRadios" id="exampleRadios2" value="option2">
